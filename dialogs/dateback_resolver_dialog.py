...
class DatebackResolverDialog(CancelAndHelpDialog):
    def __init__(self, dialog_id: str = None):
        super(DatebackResolverDialog, self).__init__(
            dialog_id or DatebackResolverDialog.__name__
        )

        self.add_dialog(
            DateTimePrompt(
                DateTimePrompt.__name__, DatebackResolverDialog.datetime_prompt_validator
            )
        )
        self.add_dialog(
            WaterfallDialog(
